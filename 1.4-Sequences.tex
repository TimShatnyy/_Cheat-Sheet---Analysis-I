...
\tsThe{(Algebra of Limits)}{
    ...
    \[
        \begin{aligned}
            ...
            \lim_{n\to\infty}(a_n-b_n) & = K-L \\
            \lim_{n\to\infty}(a_n b_n) & = KL  \\
            \lim_{n\to\infty}(C a_n)   & = CK
        \end{aligned}
    \]
    If $L\neq0$ and $b_n\neq0$ then
    \[
...
\tsThe{Monotone Convergence}{
    ...
    \begin{itemize}
        \item[(i)] A monotone sequence converges if and only if it is bounded.

        \item[(ii)] If $(a_n)$ is monotonically increasing, then
              \[
                  \lim_{n\to\infty} a_n = \sup\{a_n \mid n\in\mathbb{N}_0\}.
              \]

        \item[(iii)] If $(a_n)$ is monotonically decreasing, then
              \[
...
\tsDef{Limit Superior and Limit Inferior}{
    ...
    \\
    \begin{itemize}
        \item \emph{limit superior} of the sequence
              \[
                  \limsup_{n\to\infty} a_n
                  = \lim_{n\to\infty} \sup\{a_k \mid k \ge n\}
              \]
        \item \emph{limit inferior} of the sequence.
              \[
