...
\tsThe{Riemann Rearrangement Theorem}{
    Let $\sum a_n$ be a conditionally convergent series of real numbers, and let $L \in \mathbb{R}$. Then there exists a bijection $\varphi : \mathbb{N}_0 \to \mathbb{N}_0$ such that
    \[
